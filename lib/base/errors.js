...
internals.dictionary = {
    string: {
        ...
        token: 'value must only contain alphanumeric and underscore characters',
        base64: 'value must be a valid base64 string',
        hostname: 'value must be a valid hostname',
        creditCard: 'value must be a valid credit card',
        trim: 'value must not contain leading or trailing whitespace',
        regex: 'value does not match regex'
    },
    number: {
