...
internals.BooleanScalar = class BooleanScalar extends Base {
    ...
    parseLiteral(ast) {
        ...
        if (ast.kind !== Kind.BOOLEAN && ast.kind !== Kind.STRING && !this.type._flags.isBinary) {
        ...
        if (ast.kind === Kind.STRING) {
            ...
            if (this.type._options.convert && !this.type._flags.isBinary) {

                if (this.type._options.insensitive) {
    ...
    truthy(...values) {
        ...
        return this.type._test('boolean.truthy', (ast) => {
    ...
    falsy(...values) {
        ...
        return this.type._test('boolean.falsy', (ast) => {
    ...
    indifferent() {
        ...
        return this.type._test('boolean.indifferent', (ast) => {
