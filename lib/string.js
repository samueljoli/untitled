...
internals.guidConfigSchema = Joi.array().items(Joi.string().valid(['uuidv1', 'uuidv2', 'uuidv3', 'uuidv4', 'uuidv5']));
...
Hoek.merge(internals.StringScalar.prototype, {
    ...
    guid(versions) {
        ...
        Joi.assert(versions, internals.guidConfigSchema);
    ...
    email(opts) {
        ...
        Joi.assert(opts, internals.emailConfigSchema);
