...
internals.StringScalar = class StringScalar extends Base {
    ...
    parseLiteral(ast) {
        ...
        if (this.type._options.convert) {

            if (this.type._flags.case) {

                ast.value = this.type._flags.case === 'upper' ? ast.value.toLocaleUpperCase() : ast.value.toLocaleLowerCase();
            }
        }
    ...
    min(value) {
        ...
        return this.type._test('string.min', (ast) => {
    ...
    max(value) {
        ...
        return this.type._test('string.max', (ast) => {
    ...
    guid(versions) {
        ...
        return this.type._test('string.guid', (ast) => {
    ...
    hex() {
        ...
        return this.type._test('string.hex', (ast) => {
    ...
    email(opts) {
        ...
        return this.type._test('string.email', (ast) => {
    ...
    uri(opts) {
        ...
        return this.type._test('string.uri', (ast) => {
    ...
    lowercase() {
        ...
        const obj = this.type._test('string.lowercase', (ast) => {

            const str = ast.value;

            if (this.type._options.convert || str === str.toLocaleLowerCase()) {
    ...
    uppercase() {
        ...
        const obj = this.type._test('string.uppercase', (ast) => {

            const str = ast.value;

            if (this.type._options.convert || str === str.toLocaleUpperCase()) {
    ...
    alphanum() {
        ...
        return this.type._test('string.alphanum', (ast) => {
    ...
    token() {
        ...
        return this.type._test('string.token', (ast) => {
    ...
    base64(opts = {}) {
        ...
        return this.type._test('string.base64', (ast) => {
    ...
    hostname() {
        ...
        return this.type._test('string.hostname', (ast) => {
    ...
    creditCard() {
        ...
        return this.type._test('string.creditCard', (ast) => {
    ...
    trim() {
        ...
        return this.type._test('string.trim', (ast, options) => {
    ...
    regex(pattern, opts = {}) {
        ...
        return this.type._test('string.regex', (ast) => {
...
module.exports = function () {
    ...
    const instance = new internals.StringScalar();
